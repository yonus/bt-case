...
abstract class AppResponse {
    ...
    protected prepare<T extends AppResponse>(res: Response, response: T): Response {
        return res.status(this.status).json(AppResponse.sanitize(response));
    }

    public send(res: Response): Response {
        return this.prepare<AppResponse>(res, this);
    }
...
export class InternalErrorResponse extends AppResponse {
